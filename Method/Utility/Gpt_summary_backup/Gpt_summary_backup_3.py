		...
		<tbody>
			<tr>
				<td style="width: 50%; text-align: center;">
					<div style="text-align: left;"><strong>(start시간(초로만표시)초)</strong> 동영상 하이라이트 내용(따뜻한어투)</div>
				</td>
				<td style="width: 50%; text-align: center;">

					<p style="text-align: left;"><strong>(start시간(초로만표시)초)</strong> 동영상 하이라이트 내용(따뜻한어투)</p>
				</td>
			</tr>
			<tr>
				<td style="width: 50%; text-align: center;">start시간(초로만표시)-캡쳐이미지</td>
				<td style="width: 50%; text-align: center;">start시간(초로만표시)-캡쳐이미지</td>
			</tr>
		</tbody>
	</table>
